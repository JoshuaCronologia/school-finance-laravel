...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => isset($bill) ? 'Edit Bill #' . $bill->bill_number : 'Create Supplier Bill','subtitle' => 'Enter bill details and line items']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($bill) ? 'Edit Bill #' . $bill->bill_number : 'Create Supplier Bill'),'subtitle' => 'Enter bill details and line items']); ?>
...
<form action="<?php echo e(isset($bill) ? route('ap.bills.update', $bill) : route('ap.bills.store')); ?>" method="POST" id="bill-form">
    <?php echo csrf_field(); ?>
    <?php if(isset($bill)): ?>
        ...
        <div class="card-body">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="date" name="bill_date" class="form-input" value="<?php echo e(old('bill_date', isset($bill) ? $bill->bill_date->format('Y-m-d') : date('Y-m-d'))); ?>" required>
                </div>
                <div>
                    <label class="form-label">Due Date <span class="text-danger-500">*</span></label>
                    <input type="date" name="due_date" class="form-input" value="<?php echo e(old('due_date', isset($bill) ? $bill->due_date->format('Y-m-d') : '')); ?>" required>
                </div>
                <div>
                    <label class="form-label">Reference Number</label>
                    <input type="text" name="reference_number" class="form-input" value="<?php echo e(old('reference_number', $bill->reference_number ?? '')); ?>" placeholder="e.g., INV-2026-001">
                </div>
                <div>
                    ...
                    <select name="vendor_id" class="form-input" required>
                        ...
                        <?php $__currentLoopData = $vendors ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($vendor->id); ?>" <?php echo e(old('vendor_id', $bill->vendor_id ?? '') == $vendor->id ? 'selected' : ''); ?>>
                                <?php echo e($vendor->name); ?> <?php echo e($vendor->vendor_code ? '(' . $vendor->vendor_code . ')' : ''); ?>
                ...
                <div>
                    ...
                    <select name="department_id" class="form-input">
                        ...
                        <?php $__currentLoopData = $departments ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($dept->id); ?>" <?php echo e(old('department_id', $bill->department_id ?? '') == $dept->id ? 'selected' : ''); ?>><?php echo e($dept->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    <label class="form-label">Description</label>
                    <input type="text" name="description" class="form-input" value="<?php echo e(old('description', $bill->description ?? '')); ?>" placeholder="Brief description of the bill">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            <td>
                                <select :name="'lines[' + index + '][account_id]'" class="form-input text-sm" x-model="line.account_id">
                                    ...
                                    <?php $__currentLoopData = $accounts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($account->id); ?>"><?php echo e($account->account_code); ?> - <?php echo e($account->account_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </td>
                            <td>
                            ...
                            <td>
                                <select :name="'lines[' + index + '][tax_code_id]'" class="form-input text-sm" x-model="line.tax_code" @change="recalcTotals()">
                                    ...
                                    <?php $__currentLoopData = $taxCodes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tc->id); ?>"><?php echo e($tc->code ?? $tc->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </td>
                            <td>
    ...
    <div class="flex justify-end gap-3">
        <a href="<?php echo e(route('ap.bills.index')); ?>" class="btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp73\htdocs\school-finance-laravel\resources\views/pages/ap/bills/create.blade.php ENDPATH**/ ?>