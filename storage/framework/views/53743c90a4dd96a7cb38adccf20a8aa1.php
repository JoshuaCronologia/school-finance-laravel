...
<?php $__env->startSection('title', isset($disbursement) ? 'Edit Disbursement Request' : 'Create Disbursement Request'); ?>

<?php $__env->startSection('content'); ?>
<?php if (isset($component)) { $__componentOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => isset($disbursement) ? 'Edit Request #' . $disbursement->request_number : 'Create Disbursement Request','subtitle' => 'Fill in the request details and line items']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($disbursement) ? 'Edit Request #' . $disbursement->request_number : 'Create Disbursement Request'),'subtitle' => 'Fill in the request details and line items']); ?>
...
<?php if($errors->any()): ?>
    <?php if (isset($component)) { $__componentOriginal5194778a3a7b899dcee5619d0610f5cf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5194778a3a7b899dcee5619d0610f5cf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.alert','data' => ['type' => 'danger','class' => 'mb-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'danger','class' => 'mb-4']); ?>
...
<form action="<?php echo e(isset($disbursement) ? route('ap.disbursements.update', $disbursement) : route('ap.disbursements.store')); ?>" method="POST" enctype="multipart/form-data" x-data="disbursementForm()">
    <?php echo csrf_field(); ?>
    <?php if(isset($disbursement)): ?>
        ...
        <div class="card-body">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="date" name="request_date" class="form-input" value="<?php echo e(old('request_date', isset($disbursement) ? $disbursement->request_date->format('Y-m-d') : date('Y-m-d'))); ?>" required>
                </div>
                <div>
                    <label class="form-label">Due Date</label>
                    <input type="date" name="due_date" class="form-input" value="<?php echo e(old('due_date', isset($disbursement) ? $disbursement->due_date?->format('Y-m-d') : '')); ?>">
                </div>
                <div>
                    ...
                    <select name="payee_type" class="form-input" x-model="payeeType" required>
                        ...
                        <option value="vendor" <?php echo e(old('payee_type', $disbursement->payee_type ?? '') == 'vendor' ? 'selected' : ''); ?>>Vendor</option>
                        <option value="employee" <?php echo e(old('payee_type', $disbursement->payee_type ?? '') == 'employee' ? 'selected' : ''); ?>>Employee</option>
                        <option value="other" <?php echo e(old('payee_type', $disbursement->payee_type ?? '') == 'other' ? 'selected' : ''); ?>>Other</option>
                    </select>
                </div>
                <div>
                        ...
                        <div>
                            <select name="payee_id" class="form-input" x-model="payeeId" @change="payeeName = $event.target.options[$event.target.selectedIndex].dataset.name || ''" required>
                                ...
                                <?php $__currentLoopData = $vendors ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($vendor->id); ?>" data-name="<?php echo e($vendor->name); ?>" <?php echo e(old('payee_id', $disbursement->payee_id ?? '') == $vendor->id ? 'selected' : ''); ?>><?php echo e($vendor->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div>
                            <select name="payee_id" class="form-input" x-model="payeeId" @change="payeeName = $event.target.options[$event.target.selectedIndex].dataset.name || ''" required>
                                ...
                                <?php $__currentLoopData = $employees ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($emp->id); ?>" data-name="<?php echo e($emp->name); ?>" <?php echo e(old('payee_id', $disbursement->payee_id ?? '') == $emp->id ? 'selected' : ''); ?>><?php echo e($emp->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <input type="hidden" name="payee_name" :value="payeeName">
                        </div>
                    ...
                    <template x-if="payeeType === 'other'">
                        <input type="text" name="payee_name" class="form-input" x-model="payeeName" value="<?php echo e(old('payee_name', $disbursement->payee_name ?? '')); ?>" placeholder="Enter payee name" required>
                    </template>
                ...
                <div>
                    ...
                    <select name="department_id" class="form-input" x-model="departmentId" @change="checkBudget()" required>
                        ...
                        <?php $__currentLoopData = $departments ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($dept->id); ?>" <?php echo e(old('department_id', $disbursement->department_id ?? '') == $dept->id ? 'selected' : ''); ?>><?php echo e($dept->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="category_id" class="form-input" x-model="categoryId" @change="checkBudget()" required>
                        ...
                        <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat->id); ?>" <?php echo e(old('category_id', $disbursement->category_id ?? '') == $cat->id ? 'selected' : ''); ?>><?php echo e($cat->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="cost_center_id" class="form-input">
                        ...
                        <?php $__currentLoopData = $costCenters ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cc->id); ?>" <?php echo e(old('cost_center_id', $disbursement->cost_center_id ?? '') == $cc->id ? 'selected' : ''); ?>><?php echo e($cc->name ?? $cc->code); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    <label class="form-label">Project</label>
                    <input type="text" name="project" class="form-input" value="<?php echo e(old('project', $disbursement->project ?? '')); ?>" placeholder="Project name or code">
                </div>
                <div>
                    <label class="form-label">Payment Method</label>
                    <select name="payment_method" class="form-input">
                        <option value="">Select Method</option>
                        <?php $__currentLoopData = ['check', 'bank_transfer', 'cash', 'online']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($m); ?>" <?php echo e(old('payment_method', $disbursement->payment_method ?? '') == $m ? 'selected' : ''); ?>><?php echo e(ucfirst(str_replace('_', ' ', $m))); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="md:col-span-3">
                    <label class="form-label">Description</label>
                    <textarea name="description" class="form-input" rows="2" placeholder="Purpose of this disbursement request..."><?php echo e(old('description', $disbursement->description ?? '')); ?></textarea>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
                            ...
                            <td>
                                <select :name="'items[' + index + '][account_code]'" class="form-input text-sm" x-model="line.account_code">
                                    ...
                                    <?php $__currentLoopData = $accounts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($account->account_code); ?>"><?php echo e($account->account_code); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </td>
                            <td>
    ...
    <div class="flex justify-end gap-3">
        <a href="<?php echo e(route('ap.disbursements.index')); ?>" class="btn-secondary">Cancel</a>
...
function disbursementForm() {
    return {
        payeeType: '<?php echo e(old('payee_type', $disbursement->payee_type ?? '')); ?>',
        payeeId: '<?php echo e(old('payee_id', $disbursement->payee_id ?? '')); ?>',
        payeeName: '<?php echo e(old('payee_name', $disbursement->payee_name ?? '')); ?>',
        departmentId: '<?php echo e(old('department_id', $disbursement->department_id ?? '')); ?>',
        categoryId: '<?php echo e(old('category_id', $disbursement->category_id ?? '')); ?>',
        lines: <?php echo json_encode($initialLines, 15, 512) ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp73\htdocs\school-finance-laravel\resources\views/pages/ap/disbursements/create.blade.php ENDPATH**/ ?>