...
<head>
    ...
    <title>Login &mdash; <?php echo e(config('app.name', 'OrangeApps Finance ERP')); ?></title>
...
<body class="bg-gray-100 antialiased min-h-screen flex items-center justify-center">
    ...
    <script>
        document.getElementById('login-form').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("multi_login")); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\xampp73\htdocs\accounting\resources\views/auth/login.blade.php ENDPATH**/ ?>