<?php $__env->startSection('title', 'BIR 1601-EQ'); ?>

<?php $__env->startSection('content'); ?>
<?php if (isset($component)) { $__componentOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'BIR 1601-EQ','subtitle' => 'Quarterly Remittance Return of Creditable Income Taxes Withheld (Expanded)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'BIR 1601-EQ','subtitle' => 'Quarterly Remittance Return of Creditable Income Taxes Withheld (Expanded)']); ?>
...
<div class="card mb-6">
    <div class="card-header bg-gray-50 text-center">
        <div class="w-full">
            ...
            <p class="text-xs text-secondary-500">For Q<?php echo e($quarter); ?> <?php echo e($year); ?> (<?php echo e(['January-March','April-June','July-September','October-December'][$quarter-1]); ?>)</p>
        </div>
    </div>
    <div class="card-body max-w-2xl mx-auto">
        <table class="w-full text-sm">
            <tr class="border-b"><td class="py-3 font-medium">1. Total Taxes Withheld for the Quarter</td><td class="py-3 text-right font-mono font-bold w-48">₱<?php echo e(number_format($totalTaxWithheld, 2)); ?></td></tr>
            <tr class="border-b"><td class="py-3 font-medium">2. Less: Monthly Remittances (0619-E) for the Quarter</td><td class="py-3 text-right font-mono w-48">₱<?php echo e(number_format($totalTaxWithheld, 2)); ?></td></tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp73\htdocs\school-finance-laravel\resources\views/pages/tax/bir-1601eq.blade.php ENDPATH**/ ?>