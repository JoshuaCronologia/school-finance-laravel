...
<head>
    ...
    <title><?php echo e(config('app.name', 'School Finance ERP')); ?> &mdash; <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
...
<body class="bg-gray-50 antialiased" x-data="{ sidebarOpen: false }">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="/" class="sidebar-link <?php echo e($currentRoute === '/' ? 'sidebar-link--active' : ''); ?>">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg>
                <span>Finance Dashboard</span>
            </a>
            <a href="/accounting/dashboard" class="sidebar-link <?php echo e($currentRoute === '/accounting/dashboard' ? 'sidebar-link--active' : ''); ?>">
            ...
            <a href="/budget/planning" class="sidebar-link <?php echo e($currentRoute === '/budget/planning' ? 'sidebar-link--active' : ''); ?>">
            ...
            <a href="/budget/allocation" class="sidebar-link <?php echo e($currentRoute === '/budget/allocation' ? 'sidebar-link--active' : ''); ?>">
            ...
            <div x-data="{ open: <?php echo e(str_starts_with($currentRoute, '/reports/budget-vs-actual') || str_starts_with($currentRoute, '/reports/monthly-variance') ? 'true' : 'false'); ?> }">
                ...
                <div x-show="open" x-collapse class="ml-4 mt-1 space-y-1 border-l border-white/10 pl-3">
                    <a href="/reports/budget-vs-actual" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/budget-vs-actual' ? 'sidebar-link--active' : ''); ?>">Budget vs Actual</a>
                    <a href="/reports/monthly-variance" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/monthly-variance' ? 'sidebar-link--active' : ''); ?>">Monthly Variance</a>
                </div>
            </div>
            ...
            <div x-data="{ open: <?php echo e(str_starts_with($currentRoute, '/ap/bills') || str_starts_with($currentRoute, '/ap/disbursements') || str_starts_with($currentRoute, '/ap/approval-queue') || str_starts_with($currentRoute, '/ap/payment-processing') ? 'true' : 'false'); ?> }">
                <button @click="open = !open" class="sidebar-link w-full justify-between">
                    <span class="flex items-center gap-3">
                ...
                <div x-show="open" x-collapse class="ml-4 mt-1 space-y-1 border-l border-white/10 pl-3">
                    ...
                    <a href="/ap/approval-queue" class="sidebar-link text-xs <?php echo e($currentRoute === '/ap/approval-queue' ? 'sidebar-link--active' : ''); ?>">Approval Queue</a>
                    <a href="/ap/payment-processing" class="sidebar-link text-xs <?php echo e($currentRoute === '/ap/payment-processing' ? 'sidebar-link--active' : ''); ?>">Payment Processing</a>
                    <a href="/tax/check-writer" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/check-writer' ? 'sidebar-link--active' : ''); ?>">Check Writer</a>
                </div>
            </div>

            <a href="/vendors" class="sidebar-link <?php echo e($currentRoute === '/vendors' ? 'sidebar-link--active' : ''); ?>">
            ...
            <div x-data="{ open: <?php echo e(str_starts_with($currentRoute, '/ap/payment-processing') || str_starts_with($currentRoute, '/ar/aging') ? 'true' : 'false'); ?> }">
                <button @click="open = !open" class="sidebar-link w-full justify-between">
                    <span class="flex items-center gap-3">
                ...
                <div x-show="open" x-collapse class="ml-4 mt-1 space-y-1 border-l border-white/10 pl-3">
                    <a href="/ap/payment-processing" class="sidebar-link text-xs <?php echo e($currentRoute === '/ap/payment-processing' ? 'sidebar-link--active' : ''); ?>">Supplier Payments</a>
                    <a href="/ar/aging" class="sidebar-link text-xs <?php echo e($currentRoute === '/ar/aging' ? 'sidebar-link--active' : ''); ?>">AP Aging</a>
                </div>
            </div>
            ...
            <div x-data="{ open: <?php echo e(str_starts_with($currentRoute, '/ar/invoices') || str_starts_with($currentRoute, '/ar/collections') ? 'true' : 'false'); ?> }">
                <button @click="open = !open" class="sidebar-link w-full justify-between">
                    <span class="flex items-center gap-3">
            ...
            <a href="/ar/customers" class="sidebar-link <?php echo e($currentRoute === '/ar/customers' ? 'sidebar-link--active' : ''); ?>">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" /></svg>
                <span>Customers / Students</span>
            </a>
            <a href="/ar/aging" class="sidebar-link <?php echo e($currentRoute === '/ar/aging' ? 'sidebar-link--active' : ''); ?>">
            ...
            <a href="/ar/soa" class="sidebar-link <?php echo e($currentRoute === '/ar/soa' ? 'sidebar-link--active' : ''); ?>">
            ...
            <a href="/gl/journal-entries" class="sidebar-link <?php echo e($currentRoute === '/gl/journal-entries' ? 'sidebar-link--active' : ''); ?>">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" /></svg>
                <span>Journal Entries</span>
            </a>
            <a href="/gl/recurring" class="sidebar-link <?php echo e($currentRoute === '/gl/recurring' ? 'sidebar-link--active' : ''); ?>">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182" /></svg>
                <span>Recurring Journals</span>
            </a>
            <a href="/gl/ledger-inquiry" class="sidebar-link <?php echo e($currentRoute === '/gl/ledger-inquiry' ? 'sidebar-link--active' : ''); ?>">
            ...
            <a href="/gl/bank-reconciliation" class="sidebar-link <?php echo e($currentRoute === '/gl/bank-reconciliation' ? 'sidebar-link--active' : ''); ?>">
            ...
            <a href="/gl/period-closing" class="sidebar-link <?php echo e($currentRoute === '/gl/period-closing' ? 'sidebar-link--active' : ''); ?>">
            ...
            <div x-data="{ open: <?php echo e(str_starts_with($currentRoute, '/reports/trial-balance') || str_starts_with($currentRoute, '/reports/balance-sheet') || str_starts_with($currentRoute, '/reports/income-statement') || str_starts_with($currentRoute, '/reports/cash-flow') || str_starts_with($currentRoute, '/reports/general-ledger') || str_starts_with($currentRoute, '/reports/expense-schedule') ? 'true' : 'false'); ?> }">
                ...
                <div x-show="open" x-collapse class="ml-4 mt-1 space-y-1 border-l border-white/10 pl-3">
                    ...
                    <a href="/reports/income-statement" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/income-statement' ? 'sidebar-link--active' : ''); ?>">Income Statement</a>
                    <a href="/reports/cash-flow" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/cash-flow' ? 'sidebar-link--active' : ''); ?>">Cash Flow</a>
                    <p class="text-xs text-white/40 font-semibold uppercase mt-2 mb-1 pl-1">Books of Accounts</p>
                    <a href="/reports/general-ledger" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/general-ledger' ? 'sidebar-link--active' : ''); ?>">General Ledger</a>
                    <a href="/reports/general-journal" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/general-journal' ? 'sidebar-link--active' : ''); ?>">General Journal</a>
                    <a href="/reports/cash-receipts-book" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/cash-receipts-book' ? 'sidebar-link--active' : ''); ?>">Cash Receipts Book</a>
                    <a href="/reports/cash-disbursements-book" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/cash-disbursements-book' ? 'sidebar-link--active' : ''); ?>">Cash Disbursements Book</a>
                    <a href="/tax/special-journals" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/special-journals' ? 'sidebar-link--active' : ''); ?>">Special Journals</a>
                    <p class="text-xs text-white/40 font-semibold uppercase mt-2 mb-1 pl-1">Other Reports</p>
                    <a href="/reports/expense-schedule" class="sidebar-link text-xs <?php echo e($currentRoute === '/reports/expense-schedule' ? 'sidebar-link--active' : ''); ?>">Expense Schedule</a>
                </div>
            </div>
            ...
            <div x-data="{ open: <?php echo e(str_starts_with($currentRoute, '/tax/') ? 'true' : 'false'); ?> }">
                <button @click="open = !open" class="sidebar-link w-full justify-between">
                    <span class="flex items-center gap-3">
                ...
                <div x-show="open" x-collapse class="ml-4 mt-1 space-y-1 border-l border-white/10 pl-3">
                    ...
                    <a href="/tax/bir-1601c" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/bir-1601c' ? 'sidebar-link--active' : ''); ?>">1601-C (Compensation)</a>
                    <a href="/tax/vat-2550m" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/vat-2550m' ? 'sidebar-link--active' : ''); ?>">VAT 2550M</a>
                    <p class="text-xs text-white/40 font-semibold uppercase mt-2 mb-1 pl-1">Quarterly</p>
                    <a href="/tax/bir-1601eq" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/bir-1601eq' ? 'sidebar-link--active' : ''); ?>">1601-EQ (Expanded)</a>
                    <a href="/tax/bir-1601e" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/bir-1601e' ? 'sidebar-link--active' : ''); ?>">1601-E Return</a>
                    <a href="/tax/alphalist-quarterly" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/alphalist-quarterly' ? 'sidebar-link--active' : ''); ?>">Alphalist (QAP)</a>
                    <p class="text-xs text-white/40 font-semibold uppercase mt-2 mb-1 pl-1">Annual</p>
                    <a href="/tax/bir-1604e" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/bir-1604e' ? 'sidebar-link--active' : ''); ?>">1604-E (Expanded)</a>
                    <a href="/tax/bir-1604cf" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/bir-1604cf' ? 'sidebar-link--active' : ''); ?>">1604-CF (Comp/Final)</a>
                    <a href="/tax/alphalist-annual" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/alphalist-annual' ? 'sidebar-link--active' : ''); ?>">Alphalist (Annual)</a>
                    <p class="text-xs text-white/40 font-semibold uppercase mt-2 mb-1 pl-1">Other</p>
                    <a href="/tax/bir-2307" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/bir-2307' ? 'sidebar-link--active' : ''); ?>">BIR 2307</a>
                    <a href="/tax/alphalist" class="sidebar-link text-xs <?php echo e($currentRoute === '/tax/alphalist' ? 'sidebar-link--active' : ''); ?>">QAP / SAWT</a>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between px-4 sm:px-6 h-16">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 bg-primary-50 text-primary-700 text-xs font-semibold rounded-full">
                        ...
                        SY <?php echo e(date('Y')); ?>&ndash;<?php echo e(date('Y') + 1); ?>
...
<?php endif; ?>
        ...
        <footer class="border-t border-gray-100 px-4 sm:px-6 py-3">
            <p class="text-xs text-secondary-400 text-center">OrangeApps School Finance ERP &copy; <?php echo e(date('Y')); ?>. All rights reserved.</p>
        </footer>
    </div>
...
<?php /**PATH C:\xampp73\htdocs\school-finance-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>