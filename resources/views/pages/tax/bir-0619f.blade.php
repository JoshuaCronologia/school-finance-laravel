...
@section('content')
<x-page-header title="BIR 0619-F" subtitle="Monthly Remittance Form of Final Income Taxes Withheld">
    <x-slot name="actions">
...
<div class="bir-page" id="page1">
    ...
    <div class="bir-topbar">
        ...
        <div class="bir-formtitle">
            ...
            <div class="bir-formname">
                ...
                <div style="font-size:28px;font-weight:bold;line-height:1;">0619-F</div>
            ...
            <div class="bir-formsubtitle">
                ...
                <div style="font-size:10px;font-weight:bold;">of Final Income Taxes Withheld</div>
        ...
        <div class="bir-formno-box">
            <div style="font-size:7px;text-align:right;">0619-F 09/05ENCS P1</div>
        </div>
    </div>
    ...
    <table class="bir-table">
        <tr>
            ...
            <td class="bir-cell" style="width:20%">
                ...
                <div class="bir-value font-bold">WF010</div>
            </td>
            <td class="bir-cell" style="width:18%">
                <div class="bir-label">5 Tax Type Code</div>
                <div class="bir-value font-bold">FWT</div>
            </td>
        </tr>
    </table>
    ...
    <table class="bir-table">
        <tr>
            ...
            <td class="bir-cell bir-item-label">Amount of Final Taxes Withheld for the Month (attach schedule)</td>
...
<div class="no-print mt-4 bg-amber-50 border border-amber-200 rounded p-3 text-xs text-amber-800">
    <strong>Pending integration:</strong> Final withholding tax data (FWT) will be populated from payroll and other final tax transactions when the integration is complete. All amounts currently show ₱0.00.
</div>
