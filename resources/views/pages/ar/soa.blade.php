...
@if(isset($selectedCustomer) && $selectedCustomer)
    ...
    <div class="flex gap-3">
        <a href="{{ route('ar.soa.print', ['customer_id' => $selectedCustomer->id, 'as_of_date' => request('as_of_date', date('Y-m-d'))]) }}" target="_blank" class="btn-primary">
        ...
        <a href="{{ route('ar.soa.export', ['customer_id' => $selectedCustomer->id, 'as_of_date' => request('as_of_date', date('Y-m-d'))]) }}" class="btn-secondary">
